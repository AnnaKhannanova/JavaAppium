...
public class MainPageObject {
    ...
    public boolean isElementPresent(String locator){
        return getAmountsOfElements(locator) > 0;
    }
    ...
    public void clickElementToRightUpperCorner(String locator, String error_message){
        if (driver instanceof AppiumDriver){
            ...
            System.out.println("Method clickElementToRightUpperCorner() do nothing for platform " + Platform.getInstance().getPlatformVar());
        }
    ...
    public void swipeElementToLeft(String locator, String error_message){
        if (driver instanceof AppiumDriver){WebElement element = waitForElementPresent(
                locator,
                error_message,
                10
        );
    ...
    @Attachment
    public static byte[] screenhot(String path){
